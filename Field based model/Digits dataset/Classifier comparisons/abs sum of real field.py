...
with open('saved_scatterer.pkl', 'rb') as file:
    scatter = pkl.load(file)
...
plt.savefig("Sum of Abs Real Field Confusion matrix")
plt.clf()
...
plt.grid(True)
plt.savefig("Sum of Abs Real Field Training vs Epoch")
